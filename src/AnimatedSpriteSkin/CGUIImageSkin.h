...
#ifndef _CGUIIMAGESKIN_H_
#define _CGUIIMAGESKIN_H_
...
namespace gui
{
	...
	class ANIMATEDSPRITESKIN_API CGUIImageSkin : public IGUISkin
	{
	public:

		CGUIImageSkin(video::IVideoDriver* driver, scene::ISceneManager *scm, irr::ITimer *timer);
