...
namespace gui
{
	...
	CGUIImageSkin::CGUIImageSkin(video::IVideoDriver* driver, scene::ISceneManager *scm, irr::ITimer *timer): Font(0), Driver(driver), SceneManager(scm), Timer(timer)
{
	#ifdef _DEBUG
	setDebugName("CGUIImageSkin");
	#endif
...
bool CGUIImageSkin::Load(EGUI_ELEMENT_IMAGE_TYPE Type, std::string filename, s32 Ax,s32 Ay,s32 Aw,s32 Ah,s32 frmWidth,s32 frmHeight,bool useClrKey)
{
	if (!Driver)
		return false;
...
video::SColor CGUIImageSkin::getColor(EGUI_DEFAULT_COLOR color)
{
	return Colors[color];
}
...
void CGUIImageSkin::setColor(EGUI_DEFAULT_COLOR which, video::SColor newColor)
{
...
//! returns default color
s32 CGUIImageSkin::getSize(EGUI_DEFAULT_SIZE size)
{
	return Sizes[size];
}
...
//! sets a default size
void CGUIImageSkin::setSize(EGUI_DEFAULT_SIZE which, s32 size)
{
	if (which >= 0 && which <= EGDS_COUNT) 
		Sizes[which] = size;
}

s32 CGUIImageSkin::getAnimationSpeed(EGUI_ELEMENT_IMAGE_TYPE Type)
{
	if (Type < 0 || Type > EGEIT_COUNT)
		return 0;
...
void CGUIImageSkin::setAnimationSpeed(EGUI_ELEMENT_IMAGE_TYPE Type, s32 spd)
{
	if (Type < 0 || Type > EGEIT_COUNT)
		return;
...
void CGUIImageSkin::setLoop(EGUI_ELEMENT_IMAGE_TYPE Type, bool l)
{
	if (Type < 0 || Type > EGEIT_COUNT)
		return;
...
bool CGUIImageSkin::getLoop(EGUI_ELEMENT_IMAGE_TYPE Type)
{
	if (Type < 0 || Type > EGEIT_COUNT)
		return true;
...
void CGUIImageSkin::playForward(EGUI_ELEMENT_IMAGE_TYPE Type)
{
	if (Type < 0 || Type > EGEIT_COUNT)
		return;
...
void CGUIImageSkin::playBackward(EGUI_ELEMENT_IMAGE_TYPE Type)
{
	if (Type < 0 || Type > EGEIT_COUNT)
		return;
...
void CGUIImageSkin::resetAnimation(EGUI_ELEMENT_IMAGE_TYPE Type)
{
	if (Type < 0 || Type > EGEIT_COUNT)
		return;
...
IGUIFont* CGUIImageSkin::getFont()
{
	return Font;
}
...
//! sets a default font
void CGUIImageSkin::setFont(IGUIFont* font)
{
	if (Font)
		Font->drop();
...
const wchar_t* CGUIImageSkin::getDefaultText(EGUI_DEFAULT_TEXT text)
{
...
//! "OK", "Cancel", "Yes", "No" and so on.
void CGUIImageSkin::setDefaultText(EGUI_DEFAULT_TEXT which, const wchar_t* newText)
{
	Texts[which] = newText;
}
...
void CGUIImageSkin::draw3DButtonPaneStandard(IGUIElement* element,
...
is usually not used by ISkin, but can be used for example by more complex 
implementations to find out how to draw the part exactly. */
void CGUIImageSkin::draw3DButtonPanePressed(IGUIElement* element, 
	const core::rect<s32>& r,
	const core::rect<s32>* clip)
{
	if (!Driver)
...
\param rect: Defining area where to draw.
\param clip: Clip area.	*/
void CGUIImageSkin::draw3DSunkenPane(IGUIElement* element,
...
core::rect<s32> CGUIImageSkin::draw3DWindowBackground(IGUIElement* element,
...
\param rect: Defining area where to draw.
\param clip: Clip area.	*/
void CGUIImageSkin::draw3DMenuPane(IGUIElement* element,
	const core::rect<s32>& r,
	const core::rect<s32>* clip)
{
	if (!Driver)
...
\param rect: Defining area where to draw.
\param clip: Clip area.	*/
void CGUIImageSkin::draw3DToolBar(IGUIElement* element,
	const core::rect<s32>& r,
	const core::rect<s32>* clip)
{
	if (!Driver)
...
\param rect: Defining area where to draw.
\param clip: Clip area.	*/
void CGUIImageSkin::draw3DTabButton(IGUIElement* element, bool active,
...
\param rect: Defining area where to draw.
\param clip: Clip area.	*/
void CGUIImageSkin::draw3DTabBody(IGUIElement* element, bool border, bool background,
...
void CGUIImageSkin::drawSprite(scene::TAnimSpriteSceneNode *Sprite,  core::rect<s32> rect)
{
	if(Sprite)
	{
		Sprite->Update();
